...
기존 위키는 정보 자체는 충분했다. 다만 실전 중에 같이 쓰기에는 번거로운 부분이 있었다. 검색창 포커스를 자주 다시 잡아야 했고, 초성 검색이 안 돼 이름을 끝까지 입력해야 했고, 전투에서 먼저 보고 싶은 정보가 바로 위에 보이지 않았다.
...
다만 포켓몬 관련 콘텐츠는 라이선스 이슈가 엄격해서 퍼블릭 서비스로 크게 운영하기는 조심스럽다. 그래서 지금은 개인용으로 띄워서 실제 플레이할 때 쓰는 도구로 운용하고 있다.
